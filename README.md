...
created a model which predicts whether a mail is ham or spam
...
# data processing
the data is cleaned and preprocessed using stemming
the processed data is converted using bag of words with the help of count vectorizer
# model
 created a naive bayes model,using multinomial NB
 spam detecting model is created
